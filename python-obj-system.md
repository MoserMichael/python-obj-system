...
```
>> *** mro in detail:
>> class-in-mro:  <class '\_\_main\_\_.Foo'> id: 140225399541216 cls.\_\_dict\_\_:  {'\_\_module\_\_': '\_\_main\_\_', 'class\_var': 42, 'class\_var2': 43, '\_\_init\_\_': <function Foo.\_\_init\_\_ at 0x7f88c55e8790>, 'show\_derived': <function Foo.show\_derived at 0x7f88c55e8820>, 'make\_foo': <staticmethod object at 0x7f88c55ebdc0>, '\_\_doc\_\_': None}
>> class-in-mro:  <class '\_\_main\_\_.Base'> id: 140225399540272 cls.\_\_dict\_\_:  {'\_\_module\_\_': '\_\_main\_\_', 'base\_class\_var': 'Base', '\_\_init\_\_': <function Base.\_\_init\_\_ at 0x7f88c55e85e0>, 'show\_base': <function Base.show\_base at 0x7f88c55e8670>, 'make\_base': <staticmethod object at 0x7f88c55ebfd0>, '\_\_dict\_\_': <attribute '\_\_dict\_\_' of 'Base' objects>, '\_\_weakref\_\_': <attribute '\_\_weakref\_\_' of 'Base' objects>, '\_\_doc\_\_': None}
>> class-in-mro:  <class 'object'> id: 4409318320 cls.\_\_dict\_\_:  {'\_\_repr\_\_': <slot wrapper '\_\_repr\_\_' of 'object' objects>, '\_\_hash\_\_': <slot wrapper '\_\_hash\_\_' of 'object' objects>, '\_\_str\_\_': <slot wrapper '\_\_str\_\_' of 'object' objects>, '\_\_getattribute\_\_': <slot wrapper '\_\_getattribute\_\_' of 'object' objects>, '\_\_setattr\_\_': <slot wrapper '\_\_setattr\_\_' of 'object' objects>, '\_\_delattr\_\_': <slot wrapper '\_\_delattr\_\_' of 'object' objects>, '\_\_lt\_\_': <slot wrapper '\_\_lt\_\_' of 'object' objects>, '\_\_le\_\_': <slot wrapper '\_\_le\_\_' of 'object' objects>, '\_\_eq\_\_': <slot wrapper '\_\_eq\_\_' of 'object' objects>, '\_\_ne\_\_': <slot wrapper '\_\_ne\_\_' of 'object' objects>, '\_\_gt\_\_': <slot wrapper '\_\_gt\_\_' of 'object' objects>, '\_\_ge\_\_': <slot wrapper '\_\_ge\_\_' of 'object' objects>, '\_\_init\_\_': <slot wrapper '\_\_init\_\_' of 'object' objects>, '\_\_new\_\_': <built-in method \_\_new\_\_ of type object at 0x106d0dbb0>, '\_\_reduce\_ex\_\_': <method '\_\_reduce\_ex\_\_' of 'object' objects>, '\_\_reduce\_\_': <method '\_\_reduce\_\_' of 'object' objects>, '\_\_subclasshook\_\_': <method '\_\_subclasshook\_\_' of 'object' objects>, '\_\_init\_subclass\_\_': <method '\_\_init\_subclass\_\_' of 'object' objects>, '\_\_format\_\_': <method '\_\_format\_\_' of 'object' objects>, '\_\_sizeof\_\_': <method '\_\_sizeof\_\_' of 'object' objects>, '\_\_dir\_\_': <method '\_\_dir\_\_' of 'object' objects>, '\_\_class\_\_': <attribute '\_\_class\_\_' of 'object' objects>, '\_\_doc\_\_': 'The base class of the class hierarchy.\n\nWhen called, it accepts no arguments and returns a new featureless\ninstance that has no instance attributes and cannot be given any.\n'}
>> *** eof mro in detail
```
...
```
>> foo_obj.__class__.__dict__ :  {'__module__': '__main__', 'class_var': 42, 'class_var2': 43, '__init__': <function Foo.__init__ at 0x7f88c55e8790>, 'show_derived': <function Foo.show_derived at 0x7f88c55e8820>, 'make_foo': <staticmethod object at 0x7f88c55ebdc0>, '__doc__': None}
```
...
```
>> inspect.getmembers(foo_obj):  [('__class__', <class '__main__.Foo'>), ('__delattr__', <method-wrapper '__delattr__' of Foo object at 0x7f88c55eb2b0>), ('__dict__', {'obj_var_base': 10, 'obj_var_a': 42, 'obj_var_b': 'name'}), ('__dir__', <built-in method __dir__ of Foo object at 0x7f88c55eb2b0>), ('__doc__', None), ('__eq__', <method-wrapper '__eq__' of Foo object at 0x7f88c55eb2b0>), ('__format__', <built-in method __format__ of Foo object at 0x7f88c55eb2b0>), ('__ge__', <method-wrapper '__ge__' of Foo object at 0x7f88c55eb2b0>), ('__getattribute__', <method-wrapper '__getattribute__' of Foo object at 0x7f88c55eb2b0>), ('__gt__', <method-wrapper '__gt__' of Foo object at 0x7f88c55eb2b0>), ('__hash__', <method-wrapper '__hash__' of Foo object at 0x7f88c55eb2b0>), ('__init__', <bound method Foo.__init__ of <__main__.Foo object at 0x7f88c55eb2b0>>), ('__init_subclass__', <built-in method __init_subclass__ of type object at 0x7f88c520cde0>), ('__le__', <method-wrapper '__le__' of Foo object at 0x7f88c55eb2b0>), ('__lt__', <method-wrapper '__lt__' of Foo object at 0x7f88c55eb2b0>), ('__module__', '__main__'), ('__ne__', <method-wrapper '__ne__' of Foo object at 0x7f88c55eb2b0>), ('__new__', <built-in method __new__ of type object at 0x106d0dbb0>), ('__reduce__', <built-in method __reduce__ of Foo object at 0x7f88c55eb2b0>), ('__reduce_ex__', <built-in method __reduce_ex__ of Foo object at 0x7f88c55eb2b0>), ('__repr__', <method-wrapper '__repr__' of Foo object at 0x7f88c55eb2b0>), ('__setattr__', <method-wrapper '__setattr__' of Foo object at 0x7f88c55eb2b0>), ('__sizeof__', <built-in method __sizeof__ of Foo object at 0x7f88c55eb2b0>), ('__str__', <method-wrapper '__str__' of Foo object at 0x7f88c55eb2b0>), ('__subclasshook__', <built-in method __subclasshook__ of type object at 0x7f88c520cde0>), ('__weakref__', None), ('base_class_var', 'Base'), ('class_var', 42), ('class_var2', 43), ('make_base', <function Base.make_base at 0x7f88c55e8700>), ('make_foo', <function Foo.make_foo at 0x7f88c55e88b0>), ('obj_var_a', 42), ('obj_var_b', 'name'), ('obj_var_base', 10), ('show_base', <bound method Base.show_base of <__main__.Foo object at 0x7f88c55eb2b0>>), ('show_derived', <bound method Foo.show_derived of <__main__.Foo object at 0x7f88c55eb2b0>>)]
```
...
```
>> id(foo_obj) :  140225403597488  str(foo_obj) :  <__main__.Foo object at 0x7f88c55eb2b0>
```
...
```
>> type(foo_obj)            : <class '__main__.Foo'>  id(type(foo_obj))             : 140225399541216  type(foo_obj).__name__ :  Foo
>> str(foo_obj.__class__)   : <class '__main__.Foo'>  id(foo_obj.__class__)         : 140225399541216 foo_obj.__class__.__name__ :  Foo
>> str(Foo)                 : <class '__main__.Foo'>  id(Foo)                       : 140225399541216 Foo.__name__ : Foo
```
...
```
>> foo_obj.__class__.__dict__   : {'__module__': '__main__', 'class_var': 42, 'class_var2': 43, '__init__': <function Foo.__init__ at 0x7f88c55e8790>, 'show_derived': <function Foo.show_derived at 0x7f88c55e8820>, 'make_foo': <staticmethod object at 0x7f88c55ebdc0>, '__doc__': None}
>> Foo.__dict__                 : {'__module__': '__main__', 'class_var': 42, 'class_var2': 43, '__init__': <function Foo.__init__ at 0x7f88c55e8790>, 'show_derived': <function Foo.show_derived at 0x7f88c55e8820>, 'make_foo': <staticmethod object at 0x7f88c55ebdc0>, '__doc__': None}
>> dir(foo_obj.__class__)       : ['__class__', '__delattr__', '__dict__', '__dir__', '__doc__', '__eq__', '__format__', '__ge__', '__getattribute__', '__gt__', '__hash__', '__init__', '__init_subclass__', '__le__', '__lt__', '__module__', '__ne__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', 'base_class_var', 'class_var', 'class_var2', 'make_base', 'make_foo', 'show_base', 'show_derived']
```
...
```
>> type(foo_obj.__class__.__class__): <class 'type'>  id( foo_obj.__class__.__class__ ) : 4409318728 foo_obj.__class__.__class__.__name__ :  type
>> type(Foo)                        : <class 'type'>  id(type(Foo)) :  4409318728  Foo.__class__.__name__ : type
>> type(Foo.__class__)              : <class 'type'>  id(type(Foo.__class__)) :  4409318728  Foo.__class__.__name__ : type
>> type(Foo.__class__.__class__)    : <class 'type'>  id(type(Foo.__class__.__class__)) : 4409318728
```
...
>> calling Base.__init__
>> calling Foo.__init__
>> foo_obj :  <__main__.Foo object at 0x7f88c55ea5e0>
>> foo_obj.__dict__ :  {'obj_var_base': 10, 'obj_var_a': 42, 'obj_var_b': 'name'}
```
...
>> calling Base.__init__
>> calling Foo.__init__
>> instance_of_foo :  <__main__.Foo object at 0x7f88c55ea400>
...
```
>> Singleton_metaclass: __new__ meta_class: <class '__main__.Singleton_metaclass'> name: SquareRootOfTwo bases: () cls_dict: {'__module__': '__main__', '__qualname__': 'SquareRootOfTwo', '__init__': <function SquareRootOfTwo.__init__ at 0x7f88c55fc3a0>} kwargs: {}
...
>> SquareRootOfTwo.__init__  self: <__main__.SquareRootOfTwo object at 0x7f88c55fef70>
>> sqrt_two_a id(sqrt_root_two_a): 140225403678576 type(sqrt_root_two_a): <class '__main__.SquareRootOfTwo'> sqrt_root_two_a.value: 1.4142135623730951
>> Singleton_metaclass: __call__ args: kwargs: {}
>> sqrt_two_b id(sqrt_root_two_b) 140225403678576 type(sqrt_root_two_b): <class '__main__.SquareRootOfTwo'> sqrt_root_two_b.value: 1.4142135623730951
```
...
```
>> Singleton_metaclass_with_args: __new__ meta_class: <class '__main__.Singleton_metaclass_with_args'> name: SquareRootOfTwo bases: (<class '__main__.AnySquareRoot'>,) cls_dict: {'__module__': '__main__', '__qualname__': 'SquareRootOfTwo', '__init__': <function SquareRootOfTwo.__init__ at 0x7f88c55fca60>, '__classcell__': <cell at 0x7f88c55fdf70: empty>} kwargs: {'arg_num': 2}
...
>> Singleton_metaclass_with_args: __new__ meta_class: <class '__main__.Singleton_metaclass_with_args'> name: SquareRootOfThree bases: (<class '__main__.AnySquareRoot'>,) cls_dict: {'__module__': '__main__', '__qualname__': 'SquareRootOfThree', '__init__': <function SquareRootOfThree.__init__ at 0x7f88c55fcaf0>, '__classcell__': <cell at 0x7f88c55fddf0: empty>} kwargs: {'arg_num': 3}
...
>> sqrt_two_a id(sqrt_root_two_a): 140225403674000 type(sqrt_root_two_a): <class '__main__.SquareRootOfTwo'> sqrt_root_two_a.value: 1.4142135623730951
>> Singleton_metaclass_with_args: __call__ args: kwargs: {}
>> sqrt_two_b id(sqrt_root_two_b) 140225403674000 type(sqrt_root_two_b): <class '__main__.SquareRootOfTwo'> sqrt_root_two_b.value: 1.4142135623730951
>> Singleton_metaclass_with_args: __call__ args: kwargs: {}
>> sqrt_three_a id(sqrt_root_three_a): 140225403673856 type(sqrt_root_three_a): <class '__main__.SquareRootOfThree'> sqrt_root_three_a.value: 1.7320508075688772
>> Singleton_metaclass_with_args: __call__ args: kwargs: {}
>> sqrt_three_b id(sqrt_root_three_b) 140225403673856 type(sqrt_root_three_b): <class '__main__.SquareRootOfThree'> sqrt_root_three_b.value: 1.7320508075688772
```
