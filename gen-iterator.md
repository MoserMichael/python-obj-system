...
>> id(range_iter): 140223909612208 id(range_iter2): 140223909612880
```
...
```
>> type(not_a_generator): <function not_a_generator at 0x7f886c5ed0d0>
...
```
>> caller of generator operating system thread_id: 4569443776
>> inspect.getgeneratorstate(fib_gen): GEN_CREATED
>> (generator) fib_generator operating system thread_id: 4569443776
>> (generator) type(fib_gen.gi_frame): <class 'frame'> fib_gen.gi_frame:  <frame at 0x7f886c47b9a0, file '<string>', line 10, code fib_generator>
