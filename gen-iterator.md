...
>> id(range_iter): 140379047483408 id(range_iter2): 140379047483360
```
...
```
>> type(not_a_generator): <function not_a_generator at 0x7fac8b4e9820>
...
```
>> caller of generator operating system thread_id: 4460088768
>> inspect.getgeneratorstate(fib_gen): GEN_CREATED
>> (generator) fib_generator operating system thread_id: 4460088768
>> (generator) type(fib_gen.gi_frame): <class 'frame'> fib_gen.gi_frame:  <frame at 0x7fac8b27b9a0, file '<string>', line 10, code fib_generator>
