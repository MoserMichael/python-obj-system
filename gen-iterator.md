...
>> id(range_iter): 140336241461936 id(range_iter2): 140336241462608
```
...
```
>> type(not_a_generator): <function not_a_generator at 0x7fa293def0d0>
...
```
>> caller of generator operating system thread_id: 4375121344
>> inspect.getgeneratorstate(fib_gen): GEN_CREATED
>> (generator) fib_generator operating system thread_id: 4375121344
>> (generator) type(fib_gen.gi_frame): <class 'frame'> fib_gen.gi_frame:  <frame at 0x7fa293c7b9a0, file '<string>', line 10, code fib_generator>
