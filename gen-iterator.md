...
>> id(range_iter): 140279105604272 id(range_iter2): 140279105604944
```
...
```
>> type(not_a_generator): <function not_a_generator at 0x7f95464ed0d0>
...
```
>> caller of generator operating system thread_id: 4431646144
>> inspect.getgeneratorstate(fib_gen): GEN_CREATED
>> (generator) fib_generator operating system thread_id: 4431646144
>> (generator) type(fib_gen.gi_frame): <class 'frame'> fib_gen.gi_frame:  <frame at 0x7f954627b9a0, file '<string>', line 10, code fib_generator>
