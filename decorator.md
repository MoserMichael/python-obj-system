...
>> say_miau.__wrapped__ :  <function say_miau at 0x7f9ffaede310>
```
...
```
>> LimitCalls function: <function square_me at 0x7f9ffaee0790> max_hits: 3 log_calls: False
...
>> wrapper function: <function cube_me at 0x7f9ffaee0d30>
```
...
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7f9ffaee6160>
>> do_something in Foo
```
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7f9ffaee7c10> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7f9ffaee7c10>
...
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7f9ffaee4280>
>> idx: 1
...
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7f9ffaeec430>
...
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7f9ffaef3040>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7f9ffaeec9d0> keyword-arguments:
...
>> random number between 0 and 1 0.17222950688980465
>> random number between 0 and 1 0.10443253445212819
```
...
```
>> color red:  <__main__.Colour object at 0x7f9ffaefffa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7f9ffaeec0a0> red: 255 green: 0 blue: 0 alpha: 1.0
```
