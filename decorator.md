...
>> say_miau.__wrapped__ :  <function say_miau at 0x7fdf5a6d4b80>
```
...
```
>> LimitCalls function: <function square_me at 0x7fdf5a6dc5e0> max_hits: 3 log_calls: False
...
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7fdf5a6d9640>
>> do_something in Foo
```
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7fdf5a6e2a60> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7fdf5a6e2a60>
...
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7fdf5a6e40d0>
>> idx: 1
...
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7fdf5a6e3b50>
...
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7fdf5a6e2dc0>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7fdf5a626c40> keyword-arguments:
...
>> random number between 0 and 1 0.7304948113674915
>> random number between 0 and 1 0.21951119587267665
```
...
```
>> color red:  <__main__.Colour object at 0x7fdf5a6f6fa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7fdf5a6d5580> red: 255 green: 0 blue: 0 alpha: 1.0
```
