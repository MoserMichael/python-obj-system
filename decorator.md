...
>> say_miau.__wrapped__ :  <function say_miau at 0x7f8f47614b80>
```
...
```
>> LimitCalls function: <function square_me at 0x7f8f4761c5e0> max_hits: 3 log_calls: False
...
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7f8f47619a60>
>> do_something in Foo
```
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7f8f47621a60> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7f8f47621a60>
...
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7f8f476240d0>
>> idx: 1
...
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7f8f47611f40>
...
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7f8f47621dc0>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7f8f47426e50> keyword-arguments:
...
>> random number between 0 and 1 0.41620186882216903
>> random number between 0 and 1 0.16512093254907012
```
...
```
>> color red:  <__main__.Colour object at 0x7f8f47636fa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7f8f47615f40> red: 255 green: 0 blue: 0 alpha: 1.0
```
