...
>> say_miau.__wrapped__ :  <function say_miau at 0x7fe6ee4e7a60>
```
...
```
>> LimitCalls function: <function square_me at 0x7fe6ee4eb4c0> max_hits: 3 log_calls: False
...
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7fe6ee4ec460>
>> do_something in Foo
```
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7fe6ee4f3310> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7fe6ee4f3310>
...
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7fe6ee4f3940>
>> idx: 1
...
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7fe6ee4f6070>
...
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7fe6ee4f4700>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7fe6ee4e5ac0> keyword-arguments:
...
>> random number between 0 and 1 0.6410326815361493
>> random number between 0 and 1 0.6503021267991659
```
...
```
>> color red:  <__main__.Colour object at 0x7fe6ee4fafa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7fe6ee4f6790> red: 255 green: 0 blue: 0 alpha: 1.0
```
