...
>> say_miau.__wrapped__ :  <function say_miau at 0x7fe7ac5e5a60>
```
...
```
>> LimitCalls function: <function square_me at 0x7fe7ac5e84c0> max_hits: 3 log_calls: False
...
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7fe7ac5d9b80>
>> do_something in Foo
```
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7fe7ac5f2310> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7fe7ac5f2310>
...
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7fe7ac5f2940>
>> idx: 1
...
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7fe7ac5f32b0>
...
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7fe7ac5f6700>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7fe7ac5e4b20> keyword-arguments:
...
>> random number between 0 and 1 0.6514337733005732
>> random number between 0 and 1 0.11844840103964549
```
...
```
>> color red:  <__main__.Colour object at 0x7fe7ac5edfa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7fe7ac5f8e50> red: 255 green: 0 blue: 0 alpha: 1.0
```
