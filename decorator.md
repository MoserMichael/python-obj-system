...
>> say_miau.__wrapped__ :  <function say_miau at 0x7fa00bed6af0>
```
...
```
>> LimitCalls function: <function square_me at 0x7fa00bee0550> max_hits: 3 log_calls: False
...
>> wrapper function: <function cube_me at 0x7fa00bee0af0>
```
...
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7fa00bedc820>
>> do_something in Foo
```
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7fa00bedb9d0> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7fa00bedb9d0>
...
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7fa00bee8040>
>> idx: 1
...
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7fa00bed3d00>
...
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7fa00bedbdc0>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7fa00be25ca0> keyword-arguments:
...
>> random number between 0 and 1 0.6703078955298329
>> random number between 0 and 1 0.3227070624588819
```
...
```
>> color red:  <__main__.Colour object at 0x7fa00bef8fa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7fa00bed5430> red: 255 green: 0 blue: 0 alpha: 1.0
```
