* [Python decorator walkthrough](#s1)
  ...
  * [Decorators by means of first class functions/closures](#s1-4)
  * [Decorators in the python standard library](#s1-5)
      * [@staticmethod and @classmethod](#s1-5-1)
      * [The functools library](#s1-5-2)
* [Python decorator walkthrough](#s2)
  * [Callable objects](#s2-1)
  * [Simple decorators](#s2-2)
  * [Decorators that can receive parameters](#s2-3)
  * [Decorators by means of first class functions/closures](#s2-4)
  * [Decorators in the python standard library](#s2-5)
      * [@staticmethod and @classmethod](#s2-5-1)
      * [The functools library](#s2-5-2)
* [Python decorator walkthrough](#s3)
  * [Callable objects](#s3-1)
  * [Simple decorators](#s3-2)
  * [Decorators that can receive parameters](#s3-3)
  * [Decorators by means of first class functions/closures](#s3-4)
  * [Decorators in the python standard library](#s3-5)
      * [@staticmethod and @classmethod](#s3-5-1)
      * [The functools library](#s3-5-2)
...
>> say_miau.__wrapped__ :  <function say_miau at 0x7ff9f8712a60>
```
...
```
>> LimitCalls function: <function square_me at 0x7ff9f87144c0> max_hits: 3 log_calls: False
...
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7ff9f8705b80>
>> do_something in Foo
```
...
## <a id='s1-4' />Decorators by means of first class functions/closures
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7ff9f871e310> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7ff9f871e310>
...
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7ff9f871e940>
>> idx: 1
...
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7ff9f871f2b0>
...
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7ff9f8722700>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7ff9f8710b20> keyword-arguments:
>> do_something in Foo4
>> Return from: do_something #call: 1 return-value: None
```


## <a id='s1-5' />Decorators in the python standard library


### <a id='s1-5-1' />@staticmethod and @classmethod
...
>> random number between 0 and 1 0.451741270200938
>> random number between 0 and 1 0.9279498185593646
```
...
```
>> color red:  <__main__.Colour object at 0x7ff9f871bfa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7ff9f8721e50> red: 255 green: 0 blue: 0 alpha: 1.0
```
...
# <a id='s2' />Python decorator walkthrough


## <a id='s2-1' />Callable objects
...
>> say_miau.__name__ :  say_miau
>> say_miau.__doc__ :   docstring: print the vocalization of a Felis Catus, also known as cat 
>> say_miau.__wrapped__ :  <function say_miau at 0x7f7ef26e5a60>
```
...
## <a id='s2-3' />Decorators that can receive parameters
...
```
>> LimitCalls function: <function square_me at 0x7f7ef26e84c0> max_hits: 3 log_calls: False
>> square_me type:  <class '__main__._LimitCalls'>
>> idx: 1
>> call # 1 returns:  4
>> idx: 2
...
>> Calling: Foo #call: 1 positional-arguments: keyword-arguments:
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7f7ef26d9b80>
>> do_something in Foo
```
...
## <a id='s2-4' />Decorators by means of first class functions/closures
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7f7ef26f2310> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7f7ef26f2310>
>> type(dec_three_from_me) :  <class 'function'>
>> dec_three_from_me.__name__ :  dec_three_from_me
>> dec_three_from_me.__doc__ :  None
>> idx: 1
...
```
>> LimitCalls2 _func: None max_hits: 2 Log_calls: True
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7f7ef26f2940>
>> idx: 1
>> Calling: dec_me #call: 1 positional-arguments: 1 keyword-arguments:
>> Return from: dec_me #call: 1 return-value: 0
>> call # 1 returns:  0
...
>> Calling: Foo3 #call: 1 positional-arguments: keyword-arguments:
>> inside Foo3.__init__
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7f7ef26f32b0>
>> do_something in Foo3
```
...
```
>> LimitCalls2 _func: None max_hits: 3 Log_calls: True
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7f7ef26f6700>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7f7ef26e4b20> keyword-arguments:
>> do_something in Foo4
>> Return from: do_something #call: 1 return-value: None
```


## <a id='s2-5' />Decorators in the python standard library


### <a id='s2-5-1' />@staticmethod and @classmethod
...
```
>> absolute of a number:  3
>> random number between 0 and 1 0.20861523248450453
>> random number between 0 and 1 0.9626042457978329
```
...
```
>> color red:  <__main__.Colour object at 0x7f7ef26edfa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7f7ef26f8e50> red: 255 green: 0 blue: 0 alpha: 1.0
```


### <a id='s2-5-2' />The functools library
...
# <a id='s3' />Python decorator walkthrough


## <a id='s3-1' />Callable objects
...
>> say_miau.__name__ :  say_miau
>> say_miau.__doc__ :   docstring: print the vocalization of a Felis Catus, also known as cat 
>> say_miau.__wrapped__ :  <function say_miau at 0x7fc67f6e6a60>
```
...
## <a id='s3-3' />Decorators that can receive parameters
...
```
>> LimitCalls function: <function square_me at 0x7fc67f6ea4c0> max_hits: 3 log_calls: False
>> square_me type:  <class '__main__._LimitCalls'>
>> idx: 1
>> call # 1 returns:  4
>> idx: 2
...
>> Calling: Foo #call: 1 positional-arguments: keyword-arguments:
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7fc67f6d9b80>
>> do_something in Foo
```
...
## <a id='s3-4' />Decorators by means of first class functions/closures
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7fc67f6f2310> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7fc67f6f2310>
>> type(dec_three_from_me) :  <class 'function'>
>> dec_three_from_me.__name__ :  dec_three_from_me
>> dec_three_from_me.__doc__ :  None
>> idx: 1
...
```
>> LimitCalls2 _func: None max_hits: 2 Log_calls: True
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7fc67f6f2940>
>> idx: 1
>> Calling: dec_me #call: 1 positional-arguments: 1 keyword-arguments:
>> Return from: dec_me #call: 1 return-value: 0
>> call # 1 returns:  0
...
>> Calling: Foo3 #call: 1 positional-arguments: keyword-arguments:
>> inside Foo3.__init__
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7fc67f6f42b0>
>> do_something in Foo3
```
...
```
>> LimitCalls2 _func: None max_hits: 3 Log_calls: True
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7fc67f6f6700>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7fc67f6e4b20> keyword-arguments:
>> do_something in Foo4
>> Return from: do_something #call: 1 return-value: None
```


## <a id='s3-5' />Decorators in the python standard library


### <a id='s3-5-1' />@staticmethod and @classmethod
...
```
>> absolute of a number:  3
>> random number between 0 and 1 0.7479226795873332
>> random number between 0 and 1 0.6199564147015121
```
...
```
>> color red:  <__main__.Colour object at 0x7fc67f6effa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7fc67f6f9e50> red: 255 green: 0 blue: 0 alpha: 1.0
```


### <a id='s3-5-2' />The functools library
