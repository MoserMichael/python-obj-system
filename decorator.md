...
>> say_miau.__wrapped__ :  <function say_miau at 0x7fc8ee5e8b80>
```
...
```
>> LimitCalls function: <function square_me at 0x7fc8ee5f05e0> max_hits: 3 log_calls: False
...
>> inside Foo.__init__
>> Return from: Foo #call: 1 return-value: <__main__.Foo object at 0x7fc8ee5ed640>
>> do_something in Foo
```
...
```
>> LimitCalls2 _func: <function dec_three_from_me at 0x7fc8ee5f6a60> max_hits: 3 Log_calls: False
>> LimitCalls in nested forward_func_call. func: <function dec_three_from_me at 0x7fc8ee5f6a60>
...
>> LimitCalls in nested forward_func_call. func: <function dec_me at 0x7fc8ee5f80d0>
>> idx: 1
...
>> Return from: Foo3 #call: 1 return-value: <__main__.Foo3 object at 0x7fc8ee5f7b50>
...
>> LimitCalls in nested forward_func_call. func: <function Foo4.do_something at 0x7fc8ee5f6dc0>
>> inside Foo4.__init__
>> Calling: do_something #call: 1 positional-arguments: <__main__.Foo4 object at 0x7fc8ee526c40> keyword-arguments:
...
>> random number between 0 and 1 0.17726436600466433
>> random number between 0 and 1 0.4392729291175379
```
...
```
>> color red:  <__main__.Colour object at 0x7fc8ee60afa0> red: 255 green: 0 blue: 0
```
...
```
>> color red:  <__main__.ColourWithAlphaChannel object at 0x7fc8ee5e9580> red: 255 green: 0 blue: 0 alpha: 1.0
```
