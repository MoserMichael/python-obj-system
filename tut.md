...
```
foo instance <class '__main__.Foo'> at 0x7fe66fe3c3d0 fields: {
  'obj_var_a' : 42,
  'obj_var_b' : 'name',
  'obj_var_base' : 10
}
...
*** mro in detail:
	class-in-mro:  <class '__main__.Foo'> id: 140627663845904 dir(cls):  ['__class__', '__delattr__', '__dict__', '__dir__', '__doc__', '__eq__', '__format__', '__ge__', '__getattribute__', '__gt__', '__hash__', '__init__', '__init_subclass__', '__le__', '__lt__', '__module__', '__ne__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', 'base_clas_var', 'class_var', 'class_var2', 'make_base', 'make_foo', 'show_base', 'show_derived']
	class-in-mro:  <class '__main__.Base'> id: 140627663844960 dir(cls):  ['__class__', '__delattr__', '__dict__', '__dir__', '__doc__', '__eq__', '__format__', '__ge__', '__getattribute__', '__gt__', '__hash__', '__init__', '__init_subclass__', '__le__', '__lt__', '__module__', '__ne__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', 'base_clas_var', 'make_base', 'show_base']
	class-in-mro:  <class 'object'> id: 4479749040 dir(cls):  ['__class__', '__delattr__', '__dir__', '__doc__', '__eq__', '__format__', '__ge__', '__getattribute__', '__gt__', '__hash__', '__init__', '__init_subclass__', '__le__', '__lt__', '__ne__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__']
*** eof mro in detail
...
```foo_obj.__class__.__dict__ :  {'__module__': '__main__', 'class_var': 42, 'class_var2': 43, '__init__': <function Foo.__init__ at 0x7fe66fede5e0>, 'show_derived': <function Foo.show_derived at 0x7fe66fede670>, 'make_foo': <staticmethod object at 0x7fe66fe3cc70>, '__doc__': None}```
...
```inspect.getmembers(foo_obj):  [('__class__', <class '__main__.Foo'>), ('__delattr__', <method-wrapper '__delattr__' of Foo object at 0x7fe66fe3c3d0>), ('__dict__', {'obj_var_a': 42, 'obj_var_b': 'name', 'obj_var_base': 10}), ('__dir__', <built-in method __dir__ of Foo object at 0x7fe66fe3c3d0>), ('__doc__', None), ('__eq__', <method-wrapper '__eq__' of Foo object at 0x7fe66fe3c3d0>), ('__format__', <built-in method __format__ of Foo object at 0x7fe66fe3c3d0>), ('__ge__', <method-wrapper '__ge__' of Foo object at 0x7fe66fe3c3d0>), ('__getattribute__', <method-wrapper '__getattribute__' of Foo object at 0x7fe66fe3c3d0>), ('__gt__', <method-wrapper '__gt__' of Foo object at 0x7fe66fe3c3d0>), ('__hash__', <method-wrapper '__hash__' of Foo object at 0x7fe66fe3c3d0>), ('__init__', <bound method Foo.__init__ of <__main__.Foo object at 0x7fe66fe3c3d0>>), ('__init_subclass__', <built-in method __init_subclass__ of type object at 0x7fe66df2fa10>), ('__le__', <method-wrapper '__le__' of Foo object at 0x7fe66fe3c3d0>), ('__lt__', <method-wrapper '__lt__' of Foo object at 0x7fe66fe3c3d0>), ('__module__', '__main__'), ('__ne__', <method-wrapper '__ne__' of Foo object at 0x7fe66fe3c3d0>), ('__new__', <built-in method __new__ of type object at 0x10b038bb0>), ('__reduce__', <built-in method __reduce__ of Foo object at 0x7fe66fe3c3d0>), ('__reduce_ex__', <built-in method __reduce_ex__ of Foo object at 0x7fe66fe3c3d0>), ('__repr__', <method-wrapper '__repr__' of Foo object at 0x7fe66fe3c3d0>), ('__setattr__', <method-wrapper '__setattr__' of Foo object at 0x7fe66fe3c3d0>), ('__sizeof__', <built-in method __sizeof__ of Foo object at 0x7fe66fe3c3d0>), ('__str__', <method-wrapper '__str__' of Foo object at 0x7fe66fe3c3d0>), ('__subclasshook__', <built-in method __subclasshook__ of type object at 0x7fe66df2fa10>), ('__weakref__', None), ('base_clas_var', 'Base'), ('class_var', 42), ('class_var2', 43), ('make_base', <function Base.make_base at 0x7fe66fede550>), ('make_foo', <function Foo.make_foo at 0x7fe66fede700>), ('obj_var_a', 42), ('obj_var_b', 'name'), ('obj_var_base', 10), ('show_base', <bound method Base.show_base of <__main__.Foo object at 0x7fe66fe3c3d0>>), ('show_derived', <bound method Foo.show_derived of <__main__.Foo object at 0x7fe66fe3c3d0>>)]```
...
```id(foo_obj) :  140627696403408  str(foo_obj) :  <__main__.Foo object at 0x7fe66fe3c3d0>```

The following expressions refer to the same thing: the type of the object foo_obj, also known as the class of foo_obj

```type(foo_obj) :  <class '__main__.Foo'>  id(type(foo_obj)) :  140627663845904  type(foo_obj).__name__ :  Foo```
```str(foo_obj.__class__) :  <class '__main__.Foo'>  id(foo_obj.__class__) :  140627663845904 foo_obj.__class__.__name__ :  Foo```
```str(Foo) :  <class '__main__.Foo'>  id(Foo) :  140627663845904 Foo.__name__ :  Foo```

    The Foo class members

``` foo_obj.__class__.__dict__ :  {'__module__': '__main__', 'class_var': 42, 'class_var2': 43, '__init__': <function Foo.__init__ at 0x7fe66fede5e0>, 'show_derived': <function Foo.show_derived at 0x7fe66fede670>, 'make_foo': <staticmethod object at 0x7fe66fe3cc70>, '__doc__': None}```
``` Foo.__dict__ :  {'__module__': '__main__', 'class_var': 42, 'class_var2': 43, '__init__': <function Foo.__init__ at 0x7fe66fede5e0>, 'show_derived': <function Foo.show_derived at 0x7fe66fede670>, 'make_foo': <staticmethod object at 0x7fe66fe3cc70>, '__doc__': None}```
``` dir(foo_obj.__class__) :  ['__class__', '__delattr__', '__dict__', '__dir__', '__doc__', '__eq__', '__format__', '__ge__', '__getattribute__', '__gt__', '__hash__', '__init__', '__init_subclass__', '__le__', '__lt__', '__module__', '__ne__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', 'base_clas_var', 'class_var', 'class_var2', 'make_base', 'make_foo', 'show_base', 'show_derived']```

The following expressions refer to the same thing: the meta-type of the foo_obj.

```type(foo_obj.__class__.__class__) :  <class 'type'>  id( foo_obj.__class__.__class__ ) :  4479749448 foo_obj.__class__.__class__.__name__ :  type```
```type(Foo) :  <class 'type'>  id(type(Foo)) :  4479749448  Foo.__class__.__name__ :  type```
```type(Foo.__class__) :  <class 'type'>  id(type(Foo.__class__)) :  4479749448  Foo.__class__.__name__ :  type```
```type(Foo.__class__.__class__)  <class 'type'>  id(type(Foo.__class__.__class__)) :  4479749448```
...
```
instance_of_foo <class '__main__.Foo'> at 0x7fe66fe26790 fields: {
  'obj_var_a' : 42,
  'obj_var_b' : 'name',
  'obj_var_base' : 10
}
