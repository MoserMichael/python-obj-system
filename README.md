...
```
>> *** mro in detail:
>> class-in-mro:  <class '\_\_main\_\_.Foo'> id: 140410699704848 dir(cls):  ['\_\_class\_\_', '\_\_delattr\_\_', '\_\_dict\_\_', '\_\_dir\_\_', '\_\_doc\_\_', '\_\_eq\_\_', '\_\_format\_\_', '\_\_ge\_\_', '\_\_getattribute\_\_', '\_\_gt\_\_', '\_\_hash\_\_', '\_\_init\_\_', '\_\_init\_subclass\_\_', '\_\_le\_\_', '\_\_lt\_\_', '\_\_module\_\_', '\_\_ne\_\_', '\_\_new\_\_', '\_\_reduce\_\_', '\_\_reduce\_ex\_\_', '\_\_repr\_\_', '\_\_setattr\_\_', '\_\_sizeof\_\_', '\_\_str\_\_', '\_\_subclasshook\_\_', '\_\_weakref\_\_', 'base\_clas\_var', 'class\_var', 'class\_var2', 'make\_base', 'make\_foo', 'show\_base', 'show\_derived']
>> class-in-mro:  <class '\_\_main\_\_.Base'> id: 140410699703904 dir(cls):  ['\_\_class\_\_', '\_\_delattr\_\_', '\_\_dict\_\_', '\_\_dir\_\_', '\_\_doc\_\_', '\_\_eq\_\_', '\_\_format\_\_', '\_\_ge\_\_', '\_\_getattribute\_\_', '\_\_gt\_\_', '\_\_hash\_\_', '\_\_init\_\_', '\_\_init\_subclass\_\_', '\_\_le\_\_', '\_\_lt\_\_', '\_\_module\_\_', '\_\_ne\_\_', '\_\_new\_\_', '\_\_reduce\_\_', '\_\_reduce\_ex\_\_', '\_\_repr\_\_', '\_\_setattr\_\_', '\_\_sizeof\_\_', '\_\_str\_\_', '\_\_subclasshook\_\_', '\_\_weakref\_\_', 'base\_clas\_var', 'make\_base', 'show\_base']
>> class-in-mro:  <class 'object'> id: 4534025136 dir(cls):  ['\_\_class\_\_', '\_\_delattr\_\_', '\_\_dir\_\_', '\_\_doc\_\_', '\_\_eq\_\_', '\_\_format\_\_', '\_\_ge\_\_', '\_\_getattribute\_\_', '\_\_gt\_\_', '\_\_hash\_\_', '\_\_init\_\_', '\_\_init\_subclass\_\_', '\_\_le\_\_', '\_\_lt\_\_', '\_\_ne\_\_', '\_\_new\_\_', '\_\_reduce\_\_', '\_\_reduce\_ex\_\_', '\_\_repr\_\_', '\_\_setattr\_\_', '\_\_sizeof\_\_', '\_\_str\_\_', '\_\_subclasshook\_\_']
>> *** eof mro in detail
```
...
```
>> foo_obj.__class__.__dict__ :  {'__module__': '__main__', 'class_var': 42, 'class_var2': 43, '__init__': <function Foo.__init__ at 0x7fb3ebedb430>, 'show_derived': <function Foo.show_derived at 0x7fb3ebedb4c0>, 'make_foo': <staticmethod object at 0x7fb3ebededf0>, '__doc__': None}
```
...
```
>> inspect.getmembers(foo_obj):  [('__class__', <class '__main__.Foo'>), ('__delattr__', <method-wrapper '__delattr__' of Foo object at 0x7fb3ebedebe0>), ('__dict__', {'obj_var_a': 42, 'obj_var_b': 'name', 'obj_var_base': 10}), ('__dir__', <built-in method __dir__ of Foo object at 0x7fb3ebedebe0>), ('__doc__', None), ('__eq__', <method-wrapper '__eq__' of Foo object at 0x7fb3ebedebe0>), ('__format__', <built-in method __format__ of Foo object at 0x7fb3ebedebe0>), ('__ge__', <method-wrapper '__ge__' of Foo object at 0x7fb3ebedebe0>), ('__getattribute__', <method-wrapper '__getattribute__' of Foo object at 0x7fb3ebedebe0>), ('__gt__', <method-wrapper '__gt__' of Foo object at 0x7fb3ebedebe0>), ('__hash__', <method-wrapper '__hash__' of Foo object at 0x7fb3ebedebe0>), ('__init__', <bound method Foo.__init__ of <__main__.Foo object at 0x7fb3ebedebe0>>), ('__init_subclass__', <built-in method __init_subclass__ of type object at 0x7fb3e9e0ea10>), ('__le__', <method-wrapper '__le__' of Foo object at 0x7fb3ebedebe0>), ('__lt__', <method-wrapper '__lt__' of Foo object at 0x7fb3ebedebe0>), ('__module__', '__main__'), ('__ne__', <method-wrapper '__ne__' of Foo object at 0x7fb3ebedebe0>), ('__new__', <built-in method __new__ of type object at 0x10e3fbbb0>), ('__reduce__', <built-in method __reduce__ of Foo object at 0x7fb3ebedebe0>), ('__reduce_ex__', <built-in method __reduce_ex__ of Foo object at 0x7fb3ebedebe0>), ('__repr__', <method-wrapper '__repr__' of Foo object at 0x7fb3ebedebe0>), ('__setattr__', <method-wrapper '__setattr__' of Foo object at 0x7fb3ebedebe0>), ('__sizeof__', <built-in method __sizeof__ of Foo object at 0x7fb3ebedebe0>), ('__str__', <method-wrapper '__str__' of Foo object at 0x7fb3ebedebe0>), ('__subclasshook__', <built-in method __subclasshook__ of type object at 0x7fb3e9e0ea10>), ('__weakref__', None), ('base_clas_var', 'Base'), ('class_var', 42), ('class_var2', 43), ('make_base', <function Base.make_base at 0x7fb3ebedb3a0>), ('make_foo', <function Foo.make_foo at 0x7fb3ebedb550>), ('obj_var_a', 42), ('obj_var_b', 'name'), ('obj_var_base', 10), ('show_base', <bound method Base.show_base of <__main__.Foo object at 0x7fb3ebedebe0>>), ('show_derived', <bound method Foo.show_derived of <__main__.Foo object at 0x7fb3ebedebe0>>)]
```
...
```
>> id(foo_obj) :  140410734111712  str(foo_obj) :  <__main__.Foo object at 0x7fb3ebedebe0>
```
...
```
>> type(foo_obj) :  <class '__main__.Foo'>  id(type(foo_obj)) :  140410699704848  type(foo_obj).__name__ :  Foo
```
...
```
>> str(foo_obj.__class__) :  <class '__main__.Foo'>  id(foo_obj.__class__) :  140410699704848 foo_obj.__class__.__name__ :  Foo
```
...
```
>> str(Foo) :  <class '__main__.Foo'>  id(Foo) :  140410699704848 Foo.__name__ :  Foo
```
...
```
>> Foo.__dict__ :  {'__module__': '__main__', 'class_var': 42, 'class_var2': 43, '__init__': <function Foo.__init__ at 0x7fb3ebedb430>, 'show_derived': <function Foo.show_derived at 0x7fb3ebedb4c0>, 'make_foo': <staticmethod object at 0x7fb3ebededf0>, '__doc__': None}
```
...
```
>> type(foo_obj.__class__.__class__) :  <class 'type'>  id( foo_obj.__class__.__class__ ) :  4534025544 foo_obj.__class__.__class__.__name__ :  type
```
...
```
>> type(Foo) :  <class 'type'>  id(type(Foo)) :  4534025544  Foo.__class__.__name__ :  type
```
...
```
>> type(Foo.__class__) :  <class 'type'>  id(type(Foo.__class__)) :  4534025544  Foo.__class__.__name__ :  type
```
...
```
>> type(Foo.__class__.__class__)  <class 'type'>  id(type(Foo.__class__.__class__)) :  4534025544
```
